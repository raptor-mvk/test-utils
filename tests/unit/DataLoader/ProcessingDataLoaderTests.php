...
final class ProcessingDataLoaderTests extends TestCase
{
     ...
     */
    private function prepareDataLoader(?callable $dataProcessorMockCallback = null): DataLoaderInterface
    {
        $dataProcessorMock = Mockery::mock(DataProcessorInterface::class);
        if (null !== $dataProcessorMockCallback) {
