...
final class CommonTypeTests extends TestCase
{
     ...
     */
    public function testIsBoolReturnsCorrectValue(TypeInterface $type, bool $expected): void
    {
        $actual = $type->isBool();
     ...
     */
    public function testToStringReturnsCorrectValue(TypeInterface $type, string $expected): void
    {
     ...
     *
     * @param TypeInterface $oldType           current Type
     * @param TypeInterface $newType           newly acquired Type
     * @param string        $expectedTypeClass
     *
     * @dataProvider getCommonTypeDataProvider
     */
    public function testGetCommonTypeReturnsCorrectValue(TypeInterface $oldType, TypeInterface $newType, string $expectedTypeClass): void
    {
