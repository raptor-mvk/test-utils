...
final class CommonJSONTestDataProcessorTests extends TestCase
{
     ...
     */
    public function testProcessThrowDataParseExceptionWithCorrectMessage(DataProcessorInterface $dataProcessor, string $json, string $message): void
    {
     ...
     *
     * @return array [ [ dataProcessor, json, message ], ... ]
     */
    ...
    private function prepareIncorrectFieldNameTestData(): array
    {
        ...
        $spaceChildren = [['_name' => 't5'], ['_name' => 't6'], ['_children' => [['_name' => 't7', 'a field' => 55]]]];
        ...
        return [
            ...
            'spaces in field name' =>
                [$spacesJson, 'Field name a field at level root.2.2.0 contains forbidden characters.'],
            'digit in field name' => [$digitJson, 'Field name field163 at level root.0 contains forbidden characters.'],
        ];
    }
    ...
    private function prepareNameAndChildrenTestData(): array
    {
        ...
        $thirdLevelChildren = [['_name' => 'test5'], ['_name' => 'test6'], ['_children' => $thirdLevelGrandchildren]];
        $thirdLevelJson = json_encode([['_name' => 't7'], ['_name' => 't8'], ['_children' => $thirdLevelChildren]]);
