...
final class GeneratorDataProcessorTests extends TestCase
{
    ...
    private function prepareSingleOccurrenceTestData(): array
    {
        ...
        $expected = array_merge(
            ['int_field' => new IntType(), 'string_field' => new StringType(), 'float_field' => new FloatType()],
            ['bool_field' => new BoolType(), 'associative_array_field' => new ArrayType()],
            ['simple_array_field' => new ArrayType(), 'null_field' => new MixedType()]
        );
