...
class TestContainerWrapperDataProcessorTests extends TestCase
{
    ...
    private function notUniqueNameDataProvider(): array
    {
        ...
        return [
            'not unique name, top level' => [$topLevelJson, '/^Обнаружено неуникальное наименование test1$/'],
            'not unique name, second level' => [$secondLevelJson, '/^Обнаружено неуникальное наименование test1$/'],
            'not unique name, third level' => [$thirdLevelJson, '/^Обнаружено неуникальное наименование test3$/']
        ];
    }
