 ...
 */
final class RecursiveDirectoryDataLoader implements DirectoryDataLoaderInterface
{
    ...
    public function load(string $path, string $filenameRegExp): array
    {
        ...
        $this->iterateFiles($path, $filenameRegExp);
    ...
    /**
     * Iterates over files in specified directory by provided regexp.
     *
     * @param string $directory
     * @param string $filenameRegExp
     */
    private function iterateFiles(string $directory, string $filenameRegExp): void
    {
