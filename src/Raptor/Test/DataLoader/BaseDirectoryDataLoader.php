...
/**
 * Базовая реализация загрузчика данных из всех файлов (по маске) в директории.
 *
 * @author Михаил Каморин aka raptor_MVK
 *
 * @copyright 2019, raptor_MVK
 */
class BaseDirectoryDataLoader implements DirectoryDataLoader
{
    ...
    private function processFile(string $path, string $filename, string $extension): void
    {
        ...
        $this->processedData[$key] = $this->dataLoader->load("$unixPath/$filename");
    }
